	                        ...
	                        <td colspan="3">
                                <c:forEach var="at" items="${atList}" varStatus="status">
                                    <c:if test="${at.fileLevel eq 1}">
                                        <div>
                                            <div>
                                                <input type="file" class="form-control-file border" id="mainImgInput" name="upfiles" accept="image/*" hidden onchange="loadImg(this, 5);">
                                                ...
                                                <button type="button" class="del-img-btn">변경</button>
                                            </div>
