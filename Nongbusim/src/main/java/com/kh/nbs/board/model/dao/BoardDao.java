...
public class BoardDao {
	...
	public ArrayList<Attachment> selectAttachmentsBoard(SqlSessionTemplate sqlSession, Board b) {
		return (ArrayList)sqlSession.selectList("boardMapper.selectAttachmentsBoard",b);
	}
